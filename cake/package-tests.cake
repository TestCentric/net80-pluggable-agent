...
public struct PackageTest
{
	...
	public PackageTest(int level, string name, string description, string runner, string arguments, ExpectedResult expectedResult, params ExtensionSpecifier[] extensionsNeeded)
	{
        if (name == null)
